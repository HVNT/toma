        ...
        function extractAddress (address) {
            ...
            if (address.address_components.length) {
                for (var j = 0; j < address.address_components.length; j++) {
                    ...
                    if (_.contains(addressComponent.types, 'street_number')) {
                    ...
                    }else if (_.contains(addressComponent.types, 'neighborhood')) {
                        extractedAddress.neighborhood = addressComponent.long_name || addressComponent.short_name || '';
                        ...
                        extractedAddress.stateAbbrev = addressComponent.short_name || '';
                    } else if (_.contains(addressComponent.types, 'administrative_area_level_2')) {
                        extractedAddress.county = addressComponent.long_name || addressComponent.short_name || '';
            ...
            return {
                ...
                neighborhood: extractedAddress.neighborhood,
                city: extractedAddress.city,
                state: extractedAddress.state,
                stateAbbrev: extractedAddress.stateAbbrev,
                zip: extractedAddress.zip,
                county: extractedAddress.county
            }
        }
